...
.callback(function() {
    ...
    .click({win: this}, function(e) {
        ...
        if(theme !== 'aero') {
            ...
            if(c !== '#000000') {
                color = ' #taskbar, #startmenu, .window {background-color:'+hexToRGB(c)+' !important;} ';
            } else {
                color = '';
            }
        }
